...
// @version      1.2
// @description  Userscript for downloading document
// @author       nguynkhn
    ...
    const DOCUMENT_SOURCES = [
        // Studocu
        {
            ...
            fetchDocument: async (progressUpdater) => {
                const { documentAccess, pageDataList, seoData } = unsafeWindow.__NEXT_DATA__.props.pageProps;
...
`;
        ...
        // Scribd
        {
            ...
            fetchDocument: async (progressUpdater) => {
                const { pages, firstVisiblePage } = unsafeWindow.docManager;
...
`;
    ...
    unsafeWindow.addEventListener('DOMContentLoaded', () => {
        ...
        if (documentSource.blockCookie) {
            GM_cookie.delete({ name: documentSource.blockCookie });
        }
